...
Пример получения данных с приложения смотрите в файле udp_recever.py (доступно для версий выше 2.0)

Пример получения данных с устройства смотрите в файле EasyBCI_LSL_recive.py (доступно в версиях ниже 2.0)

Пример частотно-временного анализа ЭЭГ, записанного в режиме Спектр (доступен для версий выше 3.0) показан в файле EasyEEG_bands.ipynb
